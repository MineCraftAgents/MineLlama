...
minellama = Minellama(
    ...
    mc_port="25565",
    llm = "gpt", # For now, it only works with "llama"
    llm_model = "gpt-3.5-turbo", #"meta-llama/Llama-2-70b-chat-hf" or "meta-llama/Llama-2-7b-chat-hf" for Llama2, "gpt-3.5-turbo" or "gpt-4" for GPT
    ...
    difficulty= "peaceful",
    record_file= "./gpt35_rag_log.txt", # the ouput file 
    rag_switch=True,
...
#! botに権限付与
os.system('screen -S minecraft -X stuff "op bot\n"')
